...
const DICTIONARIES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'lobby.matchHistory.title': 'Match History',
    'lobby.matchHistory.description': 'Your past online games — final scores, results, and a replay of every move.',
    'lobby.spectate.title': 'Spectate',
    'lobby.spectate.description': 'Watch a game in progress between two other players, live.',
    'lobby.puzzles.title': 'Puzzles',
    'lobby.puzzles.description': 'Find the winning capture in a real, curated position — no account needed.',
    'lobby.leaderboard.title': 'Leaderboard',
    'lobby.leaderboard.description': 'Top players by rating — see where you rank.',
    'lobby.achievements.title': 'Achievements',
    'lobby.achievements.description': 'Badges for wins, captures, and puzzles solved.',
    'auth.signIn': 'Sign in',
  ...
  fil: {
    ...
    'lobby.matchHistory.title': 'Kasaysayan ng Laro',
    'lobby.matchHistory.description': 'Ang mga nakaraan mong laro online — huling puntos, resulta, at replay ng bawat galaw.',
    'lobby.spectate.title': 'Manood',
    'lobby.spectate.description': 'Panoorin nang live ang isang laro sa pagitan ng dalawang manlalaro.',
    'lobby.puzzles.title': 'Mga Palaisipan',
    'lobby.puzzles.description': 'Hanapin ang tamang kuha sa isang tunay na posisyon — hindi kailangan ng account.',
    'lobby.leaderboard.title': 'Leaderboard',
    'lobby.leaderboard.description': 'Nangungunang manlalaro ayon sa rating — tingnan kung saan ka nasa ranggo.',
    'lobby.achievements.title': 'Mga Tagumpay',
    'lobby.achievements.description': 'Mga badge para sa panalo, pagkuha, at nasolusyunang palaisipan.',
